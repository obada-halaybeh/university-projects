...
INSERT INTO `donations` VALUES (3,1000.00,'2025-01-02',7,1),(5,250.00,'2025-02-16',4,2),(6,5000.00,'2025-02-17',10,2),(10,1000.00,'2025-04-15',4,4),(11,2500.00,'2025-04-16',9,4),(12,350.00,'2025-04-16',6,4),(13,1100.00,'2025-11-01',5,5),(14,400.00,'2025-11-02',5,5),(15,1000.00,'2025-11-03',8,5),(16,500.00,'2025-05-02',6,6),(17,700.00,'2025-05-04',8,6),(18,200.00,'2025-05-09',10,6),(20,1000.00,'2025-05-20',7,6),(21,200.00,'2025-06-01',9,6),(25,200.00,'2025-08-09',8,7),(26,666.00,'2025-08-09',5,7);
...
INSERT INTO `donor_address` VALUES (4,'North Carolina','Raleigh','4122 Johnson Street'),(4,'Virginia','Herndon','746 Sunrise Road'),(5,'Indiana','Evansville','1980 Stratford Park'),(5,'Oregon','Portland','3288 Mattson Street'),(6,'Michigan','Grand Rapids','171 Echo Lane'),(7,'California','Fremont','1617 Ella Street'),(8,'New Jersey','New Brunswick','1889 Williams Mine Road'),(9,'New York','Albany','2611 Golden Ridge Road'),(10,'Pennsylvania','Philadelphia','2577 Berkley Street');
...
INSERT INTO `donor_event` VALUES (7,1),(8,1),(9,1),(10,1),(4,2),(7,2),(8,2),(9,2),(10,2),(5,3),(7,3),(8,3),(9,3),(10,3),(4,4),(5,4),(6,4),(7,4),(8,4),(9,4),(10,4),(4,5),(7,5),(8,5),(9,5),(10,5),(4,6),(6,6),(7,6),(8,6),(9,6),(10,6),(4,7),(5,7),(7,7),(8,7),(9,7),(10,7);
...
INSERT INTO `donor_phone` VALUES (4,'+1 503-515-6733'),(4,'+1 703-282-3635'),(5,'+1 616-478-1457'),(5,'+1 812-305-1237'),(6,'+1 267-752-9808'),(7,'+1 801-363-0000'),(8,'+1 508-973-3274'),(9,'+1 502-802-8790'),(10,'+1 813-765-7392');
...
INSERT INTO `staff` VALUES (2,'Luna','Snow','manager','luna.snow@gmail.com',75000.00),(3,'Kayla','Frost','manager','Kayla.Frost@gmail.com',80000.00),(4,'Frank','Miller','employee','Frank.Miller@gmail.com',45000.00),(5,'Grace','Wilson','employee','Grace.Wilson@gmail.com',30000.00),(6,'Test','Staff','employee','test.staff@gmail.com',40000.00),(7,'omar','alhalaybeh','employee','omar.al@gmail.com',450000.00);
...
INSERT INTO `staff_event` VALUES (2,1),(3,2),(4,2),(2,3),(5,3),(3,4),(3,5),(2,6),(5,6),(3,7),(4,7);
...
INSERT INTO `staff_phone` VALUES (2,'+1 503-341-4061'),(3,'+1 906-458-5993'),(4,'+1 361-462-3441'),(4,'+1 660-247-0609'),(5,'+1 252-282-0855');
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `AddDonor`(IN d_id INT, IN f_name VARCHAR(50), IN l_name VARCHAR(50), IN donor_type VARCHAR(50), IN donor_email VARCHAR(100), IN s_id INT)
BEGIN
...
-- Dump completed on 2025-01-26  0:34:49
